...
public class MainView extends JFrame {
	...
	public static String[] column = { "id", AppConstants.PET_NAME, AppConstants.PET_NO,
			AppConstants.PET_SPECIES, AppConstants.PET_BREED, AppConstants.PET_AGE,
			AppConstants.PET_CONTACT, AppConstants.PET_COLOR, AppConstants.PET_OWNER };
	...
	private void init() {
		...
		// init jTable
		String[][] result = ((PetDAO) BaseDAO.getAbilityDAO(DAO.PetDAO)).list(currPageNum);
	...
	private void find() {
		...
		String[][] result = ((PetDAO) BaseDAO.getAbilityDAO(DAO.PetDAO)).queryByName(param);
		condition.setText("");
